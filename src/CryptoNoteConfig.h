...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xf6ec8;
...
const char     CRYPTONOTE_NAME[]                             = "zabata";
...
const int      P2P_DEFAULT_PORT                              =  23234;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              =  23235;
